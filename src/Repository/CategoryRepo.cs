...
{
    public class CategoryRepo :  IBaseRepo<Category>, ICategoryRepo
    {
        ...
        {
            return await _category.AsNoTracking().Skip(getAllOptions.Offset).Take(getAllOptions.Limit).ToArrayAsync();
        }
